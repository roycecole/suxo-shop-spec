...
**實際落地方式**：維運人員在幫客戶開通或調整環境時，依 ShyeCMS 裡記錄的合約內容，**手動修改該客戶環境自己的設定檔/環境變數**（客戶平台本身如何讀取這些設定，見 [06-ecommerce-platform-architecture.md](06-ecommerce-platform-architecture.md)）。這個過程是人工的，ShyeCMS 不會、也不能自動把設定推送到客戶環境。
